create-react-native-app BLAL
cd BLAL
mkdir android/app/src/main/assets
* react-native bundle --platform android --dev false --entry-file index.android.js --bundle-output android/app/src/main/assets/index.android.bundle --assets-dest android/app/src/main/res
- react-native run-android (celu conectado) #
- ifconfig (probablemente tu ip sea la que no tiene ni 1, 0 o 255 al final) #
- sacudis el device #
- dev settings #
- debug server host & port #
- pones tu ip + puerto 8081 (por ej 192.168.0.13:8081) #
- volves a la app y sacudis #
- asegurarse de que este habiitado live reload y hot reload #
- Editar algun archivo para que se active el hot reload 
- asegurarse que react-native run-android no se haya apagado
